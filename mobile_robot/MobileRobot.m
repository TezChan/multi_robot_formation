classdef MobileRobot
    ...
    methods
        ...
        %------------------------------------------------------------------
        function [obj] = MobileRobot(initial_state, P, Q, radius, height, is_omni, sensors, scanner)
        ...
        %------------------------------------------------------------------
        % purpose: transition the true and estimated states of the omnidirectional robot
        %  input: obj = mobile robot object
        %           u = control input
        %          ts = time step
        % output: obj = mobile robot object
        ...
        %               angles = scan angles associated with range measurements
        %------------------------------------------------------------------
